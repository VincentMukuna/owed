...
const themeBootScript = `(function(){try{var saved=localStorage.getItem('owed-theme');var dark=saved?saved==='dark':window.matchMedia('(prefers-color-scheme: dark)').matches;var theme=dark?'dark':'light';document.documentElement.dataset.theme=theme;document.documentElement.style.colorScheme=theme;if(/Android/i.test(navigator.userAgent||''))document.documentElement.dataset.os='android';}catch(e){}})();`;
