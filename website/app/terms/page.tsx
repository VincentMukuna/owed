...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="Terms of service" title="Simple terms for a simple tool." intro="These terms explain what Owed is, what it is not, and the responsibilities that come with using it.">
      ...
      <section><h2>Contact</h2><p>For questions about these terms, open an issue in the <a href="https://github.com/VincentMukuna/owed/issues">Owed support repository</a>.</p></section>
    </LegalPage>
  );
}
