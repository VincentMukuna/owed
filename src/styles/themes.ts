...
const neutralLightColors = {
  ...
  message: "#F6F4EF",
  onPrimarySurfaceMuted: "rgba(255,255,255,0.72)",
  onPrimarySurfaceSubtle: "rgba(255,255,255,0.58)",
...
const neutralDarkColors = {
  ...
  message: "#121213",
  onPrimarySurfaceMuted: "rgba(255,255,255,0.78)",
  onPrimarySurfaceSubtle: "rgba(255,255,255,0.62)",
