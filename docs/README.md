...
|----------|-------------|
| [design-brief.md](./design-brief.md) | Current UI philosophy, visual direction, UX principles, screen specs, and component inventory |
| [prd.md](./prd.md) | Product requirements, data model, MVP scope, and release plan |
